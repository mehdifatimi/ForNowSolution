...
DROP POLICY IF EXISTS "Allow public read access to jardins" ON jardins;
DROP POLICY IF EXISTS "Allow authenticated users to insert jardins" ON jardins;
DROP POLICY IF EXISTS "Allow authenticated users to update jardins" ON jardins;
DROP POLICY IF EXISTS "Allow authenticated users to delete jardins" ON jardins;
