...
INSERT INTO product_types (id, name, name_ar, name_fr, name_en, description, is_active, created_at, updated_at) VALUES
(3, 'Type 3', 'نوع 3', 'Type 3', 'Type 3', 'Product type 3', true, NOW(), NOW()),
(6, 'Type 6', 'نوع 6', 'Type 6', 'Type 6', 'Product type 6', true, NOW(), NOW()),
(8, 'Type 8', 'نوع 8', 'Type 8', 'Type 8', 'Product type 8', true, NOW(), NOW()),
(12, 'Type 12', 'نوع 12', 'Type 12', 'Type 12', 'Product type 12', true, NOW(), NOW()),
(13, 'Type 13', 'نوع 13', 'Type 13', 'Type 13', 'Product type 13', true, NOW(), NOW()),
(17, 'Type 17', 'نوع 17', 'Type 17', 'Type 17', 'Product type 17', true, NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  name_ar = EXCLUDED.name_ar,
  name_fr = EXCLUDED.name_fr,
